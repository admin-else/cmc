...
#define cmc_free_S2C_status_pong_packet(packet)
#define cmc_free_C2S_status_request_packet(packet)
#define cmc_free_C2S_status_ping_packet(packet)
...
#define cmc_free_S2C_login_set_compression_packet(packet)
...
#define cmc_free_S2C_play_keep_alive_packet(packet)
...
#define cmc_free_S2C_play_time_update_packet(packet)
void cmc_free_S2C_play_entity_equipment_packet(
    S2C_play_entity_equipment_packet *packet);
#define cmc_free_S2C_play_spawn_position_packet(packet)
#define cmc_free_S2C_play_update_health_packet(packet)
void cmc_free_S2C_play_respawn_packet(S2C_play_respawn_packet *packet);
#define cmc_free_S2C_play_player_look_and_position_packet(packet)
#define cmc_free_S2C_play_held_item_change_packet(packet)
#define cmc_free_S2C_play_use_bed_packet(packet)
#define cmc_free_S2C_play_animation_packet(packet)
void cmc_free_S2C_play_spawn_player_packet(
    S2C_play_spawn_player_packet *packet);
#define cmc_free_S2C_play_collect_item_packet(packet)
...
#define cmc_free_S2C_play_spawn_experience_orb_packet(packet)
#define cmc_free_S2C_play_entity_velocity_packet(packet)
#define cmc_free_S2C_play_entity_packet(packet)
#define cmc_free_S2C_play_entity_relative_move_packet(packet)
#define cmc_free_S2C_play_entity_look_packet(packet)
#define cmc_free_S2C_play_entity_look_and_relative_move_packet(packet)
#define cmc_free_S2C_play_entity_teleport_packet(packet)
#define cmc_free_S2C_play_entity_head_look_packet(packet)
#define cmc_free_S2C_play_entity_status_packet(packet)
#define cmc_free_S2C_play_attach_entity_packet(packet)
void cmc_free_S2C_play_entity_metadata_packet(
    S2C_play_entity_metadata_packet *packet);
#define cmc_free_S2C_play_entity_effect_packet(packet)
#define cmc_free_S2C_play_remove_entity_effect_packet(packet)
#define cmc_free_S2C_play_set_experience_packet(packet)
void cmc_free_S2C_play_chunk_data_packet(S2C_play_chunk_data_packet *packet);
#define cmc_free_S2C_play_block_change_packet(packet)
#define cmc_free_S2C_play_block_action_packet(packet)
#define cmc_free_S2C_play_block_break_animation_packet(packet)
#define cmc_free_S2C_play_effect_packet(packet)
void cmc_free_S2C_play_sound_effect_packet(
    S2C_play_sound_effect_packet *packet);
#define cmc_free_S2C_play_change_game_state_packet(packet)
#define cmc_free_S2C_play_player_abilities_packet(packet)
...
#define cmc_free_S2C_play_change_difficulty_packet(packet)
#define cmc_free_C2S_play_keep_alive_packet(packet)
// CGSE: free_methods_h